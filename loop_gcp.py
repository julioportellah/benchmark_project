...
if __name__ == '__main__':
    ...
    print(f"creation time: {time_diff}")
    delete_operation = delete_instance(compute, project,zone,'test-dev-vm')
    wait_for_operation(compute, project, zone, delete_operation['name'])
    print("Process done")
